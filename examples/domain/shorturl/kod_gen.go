...
func init() {
	kod.Register(&kod.Registration{
		Name:      "github.com/go-kod/kod/examples/domain/shorturl/Component",
...
func (s component_local_stub) Generate(ctx context.Context, a1 *GenerateRequest) (r0 *GenerateResponse, err error) {
	...
	info := kod.CallInfo{
		Impl:       s.impl,
		Component:  s.name,
		FullMethod: "github.com/go-kod/kod/examples/domain/shorturl/Component.Generate",
		Method:     "Generate",
	}
...
func (s component_local_stub) Get(ctx context.Context, a1 *GetRequest) (r0 *GetResponse, err error) {
	...
	info := kod.CallInfo{
		Impl:       s.impl,
		Component:  s.name,
		FullMethod: "github.com/go-kod/kod/examples/domain/shorturl/Component.Get",
		Method:     "Get",
	}
