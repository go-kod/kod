...
const (
	// Test1Component is the full name of the component [github.com/go-kod/kod/tests/case2/Test1Component].
	...
	// Test2Component is the full name of the component [github.com/go-kod/kod/tests/case2/Test2Component].
